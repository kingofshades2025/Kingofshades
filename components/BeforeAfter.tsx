  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="absolute bottom-3 right-3 rounded-full border border-gold/30 bg-black/50 px-2.5 py-1 text-[11px] font-semibold text-gold backdrop-blur">
          After — Tinted
        </span>
      </div>

      {/* BEFORE (untinted / glare) — clipped layer */}
      <div
        className="absolute inset-0"
        style={{
      ...
      >
        ...
        />
        <span className="absolute bottom-3 left-3 rounded-full border border-black/20 bg-white/70 px-2.5 py-1 text-[11px] font-semibold text-black/80 backdrop-blur">
          Before — Glare
        </span>
      </div>
